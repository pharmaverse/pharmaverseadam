...
write_labels <- function(data, dataset_name, suffix) {
  ...
  tryCatch(
    ...
    error = function(e) {
      warning(sprintf(
        "Error retrieving dataset %s specs - Please check adams-specs.json file",
        dataset_name
      ))
    }
  )
...
# dict to match admiral JSON specs suffixes
suffixes_dict <- list("_ophtha" = "_P", "_onco" = "_O", "_vaccine" = "_V", "_peds" = "_E")
mc <- metacore::spec_to_metacore("inst/extdata/adams-specs.json",
...
for (pkg in packages_list) {
  ...
  results <- parallel::mclapply(templates, run_template)
