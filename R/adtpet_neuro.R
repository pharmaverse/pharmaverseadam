...
#'
#' @name adtpet_neuro
#' @title Tau PET Scan Analysis Dataset
...
#'   SUVRAFTP \tab AVID FTP Standard Uptake Ratio Neocortical Composite Inferior Cerebellar Gray Matter    \cr
#'   SUVRBFTP \tab BERKELEY FTP Standard Uptake Ratio Neocortical Composite Inferior Cerebellar Gray Matter
#' }

#'
#' @source Generated from admiralneuro package (template ad_adtpet.R).
#' @references None
#'
#' @examples
#' data("adtpet_neuro")
